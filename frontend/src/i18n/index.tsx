...
const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    onb_legal_confirm: "I confirm that my information is true and correct.",
    onb_age_locked: "Age (locked after registration)",
    onb_age_locked_hint: "Your age can't be changed after registration.",
  ...
  de: {
    ...
    onb_legal_confirm: "Ich bestätige, dass meine Angaben der Wahrheit entsprechen.",
    onb_age_locked: "Alter (nach Registrierung gesperrt)",
    onb_age_locked_hint: "Dein Alter kann nach der Registrierung nicht mehr geändert werden.",
