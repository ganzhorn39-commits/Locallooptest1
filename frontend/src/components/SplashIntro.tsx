...
const styles = StyleSheet.create({
  ...
  glow: { position: "absolute", width: 130, height: 130, borderRadius: 65, backgroundColor: "#FF5A36", opacity: 0.35 },
  logo: { width: 88, height: 88, borderRadius: 26, backgroundColor: "#FF5A36", alignItems: "center", justifyContent: "center" },
